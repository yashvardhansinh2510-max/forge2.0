"""GROHE Catalog ADDITIVE Batch 3 (2026-08) — 5 more supplier files.
...
categories/products). Files: Wall Mounted, Tall Body Basin Mixer, Trigger & Tank, Spout, Thermostat.
...
Usage:
    python scripts/run_grohe_batch3_additive.py --dry-run
    python scripts/run_grohe_batch3_additive.py --execute
"""
...
from grohe_xlsx_extract import extract_all, FILES_BATCH3, ORIGINAL_FILENAMES_BATCH3, GroheRow  # noqa: E402
...
async def run(dry_run: bool) -> dict:
    ...
    print("=" * 78)
    print("BATCH 3 — EXTRACT & VALIDATE 5 SUPPLIER FILES")
    print("=" * 78)
    all_rows = extract_all(XLSX_DIR, FILES_BATCH3, ORIGINAL_FILENAMES_BATCH3)
    ...
    print(f"Existing Grohe products (batches 1+2, untouched by this run): {len(existing_products)}")
...
if __name__ == "__main__":
    ...
    out_path = BACKUP_ROOT / "grohe_batch3_report.json"
