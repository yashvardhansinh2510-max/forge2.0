...
def test_portrait_image_keeps_its_upright_source_orientation():
...
def test_square_and_wide_sources_are_not_cropped_to_a_document_canvas():
...
def test_exif_orientation_is_applied_without_a_second_rotation_or_crop():
